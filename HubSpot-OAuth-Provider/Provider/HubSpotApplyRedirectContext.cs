...
namespace Owin.Security.Providers.HubSpot
{
    ...
    public class HubSpotApplyRedirectContext : BaseContext<HubSpotAuthenticationOptions>
    {
        /// <summary>
        ...
        public HubSpotApplyRedirectContext(IOwinContext context, HubSpotAuthenticationOptions options,
