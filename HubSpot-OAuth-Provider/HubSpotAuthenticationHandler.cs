...
{
    public class HubSpotAuthenticationHandler : AuthenticationHandler<HubSpotAuthenticationOptions>
    {
        // see https://www.hubspot.com/accounts/protocol/oauth/web-apps/authorization.html for docs 
        private const string AuthorizeEndpoint = "https://app.hubspot.com/oauth/authorize";
        private const string TokenEndpoint = "https://api.hubapi.com/oauth/v1/token";
        private const string UserInfoEndpointFormat = "https://api.hubapi.com/oauth/v1/refresh-tokens/{0}";
        private const string XmlSchemaString = "http://www.w3.org/2001/XMLSchema#string";

        private readonly HttpClient _httpClient;
        private readonly ILogger _logger;

        public HubSpotAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                // Request user info
                var userRequest = new HttpRequestMessage(HttpMethod.Get, String.Format(UserInfoEndpointFormat, refreshToken));
                ...
                var context = new HubSpotAuthenticatedContext(Context, accessToken, expires, refreshToken, userJson);
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                var beforeRedirectContext = new HubSpotBeforeRedirectContext(Context, Options);
                ...
                var redirectContext = new HubSpotApplyRedirectContext(Context, Options, properties, authorizationEndpoint);
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            if (Options.CallbackPath.HasValue && Options.CallbackPath == Request.Path)
            {
                ...
                var context = new HubSpotReturnEndpointContext(Context, ticket);
